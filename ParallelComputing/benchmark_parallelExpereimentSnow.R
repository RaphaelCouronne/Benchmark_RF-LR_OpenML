...
save(result_small, file = "../Data_BenchmarkOpenMl/Final/Results/Windows/benchmark_results_snow_small_strat.RData")
...
# 6. Distribute calculation
start <- Sys.time(); result_medium <- sfLapply(OMLDATASETS, wrapper) ; Sys.time()-start


# 7. Stop snowfall 
sfStop() 

save(result_medium, file = "../Data_BenchmarkOpenMl/Final/Results/Windows/benchmark_results_snow_medium_strat.RData")
...
# 6. Distribute calculation
start <- Sys.time(); result_big <- sfLapply(OMLDATASETS, wrapper) ; Sys.time()-start


# 7. Stop snowfall 
sfStop() 

save(result_big, file = "../Data_BenchmarkOpenMl/Final/Results/Windows/benchmark_results_snow_big_strat.RData")
print("done with big")
