makeRLearner.classif.cvglmnet.modified = function() {
  makeRLearnerClassif(
    cl = "classif.cvglmnet",
    package = "glmnet",
...
#' @export
trainLearner.classif.cvglmnet.modified = function(.learner, .task, .subset, .weights = NULL, ...) {
...
#' @export
predictLearner.classif.cvglmnet.modified = function(.learner, .model, .newdata, ...) {
